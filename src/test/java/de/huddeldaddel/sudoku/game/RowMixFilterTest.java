...
public class RowMixFilterTest {
    ...
    public void testFilter() {
        ...
        final List<Field> result = new RowMixFilter().filter(inputField).collect(Collectors.toList());
    ...
    public void testGetRowMix() {
        ...
        final Field inputField = new Field(grid);
        final Field result = RowMixFilter.getRowMix(inputField, List.of(2, 1, 0));
